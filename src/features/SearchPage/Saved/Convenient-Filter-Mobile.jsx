...
ConvenientFilterMobile.propTypes = {
...
function ConvenientFilterMobile({
  title = "",
  data = [],
  name = "",
  onChange = null,
  ...
  const handleOnChange = (value, event) => {
    ...
    if (array.length > 0) {
      onChange({ convenient: `[${array}]` });
    } else {
      onChange({ convenient: undefined });
    }
  };
  return (
    <>
...
export default ConvenientFilterMobile;
